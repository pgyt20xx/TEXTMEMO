...
//		            ListFragment.listview.clearTextFilter();
//		        } else {
//		            ListFragment.listview.setFilterText(newText.toString());
//		        }
				return false;
			}
		});
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				result = getString(R.string.title_section1).toUpperCase(l);
				return result;
			case 1:
				result = getString(R.string.title_section2).toUpperCase(l);
				return result;
//			case 2:
